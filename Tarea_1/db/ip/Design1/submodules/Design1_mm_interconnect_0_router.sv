...
module Design1_mm_interconnect_0_router_default_decode
  #(
...
module Design1_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD9 = log2ceil(64'h100010 - 64'h100000); 
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h110010;
    ...
    Design1_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x60000 .. 0x60010 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 21'h60000  && read_transaction  ) begin
    ...
    // ( 0x100000 .. 0x100010 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 21'h100000  && read_transaction  ) begin
            src_channel = 11'b01000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x110000 .. 0x110010 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 21'h110000  && read_transaction  ) begin
