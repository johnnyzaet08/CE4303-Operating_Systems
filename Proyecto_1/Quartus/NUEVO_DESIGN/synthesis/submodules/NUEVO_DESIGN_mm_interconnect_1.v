// NUEVO_DESIGN_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module NUEVO_DESIGN_mm_interconnect_1 (
	...
	wire  [98:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                                  // nios2_qsys_0_instruction_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [0:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire  [26:0] rom_s1_agent_m0_address;                                                            // ROM_s1_agent:m0_address -> ROM_s1_translator:uav_address
	...
	wire  [99:0] rom_s1_agent_rf_source_data;                                                        // ROM_s1_agent:rf_source_data -> ROM_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] rom_s1_agent_rsp_fifo_out_data;                                                     // ROM_s1_agent_rsp_fifo:out_data -> ROM_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> ROM_s1_agent:cp_data
	...
	wire  [98:0] nios2_qsys_0_instruction_master_agent_cp_data;                                      // nios2_qsys_0_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [98:0] rom_s1_agent_rp_data;                                                               // ROM_s1_agent:rp_data -> router_001:sink_data
	...
	NUEVO_DESIGN_mm_interconnect_1_router router (
	...
	NUEVO_DESIGN_mm_interconnect_1_router_001 router_001 (
	...
	NUEVO_DESIGN_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NUEVO_DESIGN_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NUEVO_DESIGN_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NUEVO_DESIGN_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
